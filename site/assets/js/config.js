...
export const CONFIG = {
  ...
  // Public strategy research: a simulated backtest of a generic ETH cash and carry, not fund performance.
  ...
  // (KAGB §§ 306b, 321/323): hides fund terms, fees and allocation sizes. Elements marked
